      ...
      <section className="section">
        <div className="container">
          <div className="content">
            ...
            данных и меры по обеспечению безопасности персональных данных. 1.1.
            ...
            интернет по сетевому адресу https://antikdecor.ru. 2.4.
            ...
            определяемому Пользователю веб-сайта https://antikdecor.ru. 2.9.
            ...
            посетитель веб-сайта https://antikdecor.ru. 2.11. Предоставление
            ...
            персональных данных.
            <h4>3. Основные права и обязанности Оператора </h4>3.1. Оператор
            ...
            обработки персональных данных; — принимать правовые, организационные
            ...
            данных; — прекратить передачу (распространение, предоставление,
            ...
            <h4>4. Основные права и обязанности</h4>
            субъектов персональных данных 4.1. Субъекты персональных данных
            имеют право: — получать информацию, касающуюся обработки его
            ...
            <h4>5. Принципы обработки персональных данных</h4> 5.1. Обработка
            персональных данных осуществляется на законной и справедливой
            основе. 5.2. Обработка персональных данных ограничивается
            ...
            сбора персональных данных. 5.3. Не допускается объединение баз
            данных, содержащих персональные данные, обработка которых
            осуществляется в целях, несовместимых между собой. 5.4. Обработке
            подлежат только персональные данные, которые отвечают целям их
            обработки. 5.5. Содержание и объем обрабатываемых персональных
            ...
            <h4>6. Условия обработки персональных данных</h4> 6.1. Обработка
            персональных данных осуществляется с согласия субъекта персональных
            данных на обработку его персональных данных. 6.2. Обработка
            ...
            оператора функций, полномочий и обязанностей. 6.3. Обработка
            ...
            Российской Федерации об исполнительном производстве. 6.4. Обработка
            ...
            выгодоприобретателем или поручителем. 6.5. Обработка персональных
            ...
            субъекта персональных данных. 6.6. Осуществляется обработка
            ...
            (далее — общедоступные персональные данные). 6.7. Осуществляется
            ...
            данных. 7.2. Оператор осуществляет автоматизированную обработку
            ...
            таковой. <h4>8. Конфиденциальность персональных данных</h4> Оператор
            ...
            федеральным законом. <h4>9. Заключительные положения</h4> 11.1.
            ...
            к Оператору с помощью электронной почты 11.2. В данном документе
            ...
            версией. 11.3. Актуальная версия Политики в свободном доступе
            расположена в сети Интернет по адресу https://antikdecor.ru.
          </div>
        </div>
      </section>
    </div>
